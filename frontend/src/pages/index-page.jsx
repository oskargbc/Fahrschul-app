...
const solutions = [
    {
        name: 'Lernen nach Themen',
        description: 'Lerne die Fragen in Reihenfolge der Themen',
        href: '#',
        icon: ChartBarIcon,
    },
    {
        name: 'Lernkartei',
        description: 'Lerne die Fragen in Reihenfolge deines Fortschrittes',
        href: '#',
...
export default class HomePage extends React.Component {
   constructor(props) {
    ...
    componentDidMount(props){
       this.setState({ name: cookies.get("user") });
   }

    render () {
        console.log(localStorage.getItem("loggedin"), "cock")
        return (
